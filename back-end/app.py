...
class SimpleNet(nn.Module):
    def __init__(self, input_size=821):
        super().__init__()
...
def predict():
    ...
    features = np.array([dep_time, dep_delay, distance, taxi_out, wheels_off, arr_del15] + airline_features + month_features + dayofmonth_features + dayofweek_features + originairportid_features + destairportid_features)
