    ...
    <div>
      <form onSubmit={handleSubmit}>
        ...
        <select
          ...
          {originairportids.map((originairportid) => (
            <option key={originairportid} value={originairportid}>
              {originairportid.replace('OriginAirportID_', '')}
            </option>
          ))}
        </select>
